...
* Erklären der Begriffe Datenbank, Werte und Dimensionen in Dokumentation
...
* In `as.data.frame()`
    * Gewichtete Werte speziell behandeln? `my_content$measures[[i]]$weight`
    * Precision (wenn verfügbar) ausgeben: `my_content$cubes[[i]]$precision`
