...
This output is generated from `r style_resource(id, ext = "json")` and shows a summary of the available metatata. Other parts of the metadata can be extracted with `$` using the keys from the json specification.
