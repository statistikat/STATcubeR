...
The API key can be displayed under the [preferences menu](https://statcube.at/statistik.at/ext/statcube/jsf/preferences/editPreferences.xhtml) of STATcube
...
You can be set persistently by modifying `.Renviron`.
...
All employees can log into the external STATcube server using their statportal credentials and use the API like a user with a subscrption.
Additionaly, there are internal STATcube servers that can be used with `r STATcubeR`.
Please refer to the following internal confluence documentation if you want to send requests to one of our internal servers:
https://confluence.com/xkakjff
