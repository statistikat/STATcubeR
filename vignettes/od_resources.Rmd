...
This artricle explains how and where `{STATcubeR}` caches resources from http://data.statistik.gv.at in the local file system.
Understanding this behavior will allow you to enable persistent caches and directly use the cached resources.

## Overview

By default, `{STATcubeR}` caches all accessed resources from https://data.statistik.gv.at in the temporary directory of the current R session.
