...
If every combination of tumor tpye, year, region and sex would contain a seperate row the number of rows would be the following.
...
This section will show the different metadata components contained in the table object.
...
The regional classification contains 9 elements which correspond to the NUTS2 regions of austria.
